    ...
    <div className="navbar bg-prime">
      <div className="container">
        ...
        <div className="nav-wrapper flex sm:flex-wrap md:flex-col lg:flex-row items-center justify-between md:px-0 px-10">
          ...
          <ul className={`flex flex-col md:flex-row font-pops items-center gap-5 py-6 md:py-7 md:gap-12 lg:py-10 md:p-0 md:w-auto w-full absolute right-0 z-20  bg-prime/20 backdrop-blur-lg md:bg-transparent md:static duration-300  ${use ? 'top-[170px]':'top-[-250px]'}`}>
